(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('react'), require('@wfp/icons'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'prop-types', 'react', '@wfp/icons', 'react-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.WfpUiReact = {}, global.PropTypes, global.React, global['@wfp/icons'], global.ReactDOM));
}(this, (function (exports, PropTypes, React, icons, ReactDOM) { 'use strict';
  ...
  */
  ...
  var ReduxFormWrapper = function ReduxFormWrapper(_ref) {
    ...
    if ( InputComponent !== undefined) {
      warning_1(didWarnAboutDeprecation, 'The `InputComponent` prop of ReduxFormWrapper has been deprecated and will be removed ' + 'in the next major release of `@wfp/ui`. Please use ' + '`children` instead.');
