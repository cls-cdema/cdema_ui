...
import React, { useState, useEffect, useRef, PureComponent, Component, createRef } from 'react';
import 'invariant';
import { iconSearch, iconCloseGlyph, iconWarning, iconWarningSolid, iconInfoSolid, iconCheckmark, iconHome, iconCheckmarkGlyph, iconWarningGlyph, iconWfpLogoExtendedEn, iconWfpLogoVerticalEn, iconArrowRight, iconArrowLeft, iconClose, iconCaretDown, iconChevronLeft, iconChevronRight, iconCaretUp, iconEllipsis, iconLocked, iconOverflowMenu, iconErrorGlyph, iconMenu, iconUser } from '@wfp/icons';
...
}, _defineProperty(_Blockquote$propTypes, "children", PropTypes.node), _defineProperty(_Blockquote$propTypes, "code", PropTypes.bool), _defineProperty(_Blockquote$propTypes, "light", PropTypes.bool), _defineProperty(_Blockquote$propTypes, "toggleable", PropTypes.bool), _defineProperty(_Blockquote$propTypes, "title", PropTypes.node), _defineProperty(_Blockquote$propTypes, "kind", PropTypes.oneOf[('success')]), _defineProperty(_Blockquote$propTypes, "withIcon", PropTypes.bool), _defineProperty(_Blockquote$propTypes, "icon", PropTypes.oneOfType([PropTypes.node, PropTypes.object])), _Blockquote$propTypes);
...
var Loading = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Loading, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement("title", null, "Loading"),  null, /*#__PURE__*/React.createElement("circle", {
        className:  null,
        cx: "0",
        cy: "0",
        r: "37.5"
...
var sdgIcon = /*#__PURE__*/React.createElement("svg", {
...
var Footer = function Footer(_ref) {
  ...
  var footer = /*#__PURE__*/React.createElement("footer", {
  ...
  }, logoExtended ? /*#__PURE__*/React.createElement("img", {
    ...
    description: "WFP",
    className: "wfp--footer__cta-logo-small"
  }), sdgIcon, secondary && /*#__PURE__*/React.createElement("div", {
    className: "wfp--footer__secondary"
  }, secondary)))), /*#__PURE__*/React.createElement(Wrapper, {
    className: "wfp--footer__meta",
    pageWidth: pageWidth
  }, metaContent && /*#__PURE__*/React.createElement("div", {
    className: "wfp--footer__meta__content"
  }, metaContent), metaLinks && /*#__PURE__*/React.createElement("div", {
...
var Tooltip = function Tooltip(_ref) {
  ...
  var _usePopper = usePopper(referenceElement.current, popperElement.current, _objectSpread2({
    placement: placement,
  ...
  }, actions), children) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.cloneElement(children, _objectSpread2({
    ref: referenceElement
...
List.propTypes = {
   ...
   * Specify a kind.
   */
  kind: PropTypes.oneOf(['simple', 'simple-inline', 'details', 'bullets', 'ordered']),
...
var Tab = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, renderListElement ? renderListElement(_objectSpread2(_objectSpread2(_objectSpread2({}, this.props), liProps), {}, {
        anchor: anchorProps,
...
var currencyCalc = function currencyCalc(props, after, before, afterSingular, isAbsolute) {
  ...
  if ((!value || value === 'NaN' || parseFloat(value) === 0) && hideZero) return false;else if (calcOnly) return calcObject;else if (svg) return SvgUnit(calcObject, props);else if (string) return StringUnit(calcObject);else if (value !== false) return /*#__PURE__*/React.createElement("span", {
    className: className
...
var SimpleCalc = function SimpleCalc(props, after, before) {
  ...
  if (calcOnly) return calcObject;else if (svg) return SvgUnit({
    ...
    before: before,
    after: after
  }, props);else if (string) return StringUnit(calcObject);else if (value !== false) return /*#__PURE__*/React.createElement("span", {
    className: className
  }, value);
};
...
var YearMonthCalc = function YearMonthCalc(props) {
  ...
  if (calcOnly) return calcObject;else if (svg) return SvgUnit(calcObject, props);else if (string) return StringUnit(calcObject);else if (calcObject !== false) return /*#__PURE__*/React.createElement("span", {
    className: className
  }, calcObject.value);
};
...
Unit.propTypes = {
  ...
  */
  ...
  /**
    The unit type  */
  type: PropTypes.oneOf([undefined, 'none', 'narrow', 'usd', 'partners', 'beneficiaries', 'households', 'months', 'mt', 'metricTons', 'kg', 'num', 'yearMonth', 'level', 'people', 'countries', 'percentage'])
};
Unit.defaultProps = {
  type: 'none',
  svg: false,
...
export { BannerNavigation, BannerNavigationItem, BannerNavigationWithContent, Blockquote, Breadcrumb, BreadcrumbHome, BreadcrumbItem, Button, Card, Checkbox, ContentSwitcher, Credits, DateRangePickerInput, FileUploader, FileUploaderButton, FileUploaderDropContainer, FileUploaderItem, Footer, Form, FormControls, FormError, FormGroup, FormHint, FormItem, FormLabel, FormWizard, Icon, InfoBar, InlineLoading, Input, InputGroup, Link, List, ListItem, Loading, MainNavigation, MainNavigationItem, MdxComponents, Modal, ModalWrapper, Module, ModuleBody, ModuleFooter, ModuleHeader, NumberInput$1 as NumberInput, Pagination, RadioButton, ReadMore, ReduxFormWrapper, NumberInput as Search, SecondaryNavigation, SecondaryNavigationTitle, Select, SelectItem, SelectItemGroup, SingleDatePickerInput, Slider, StepNavigation, StepNavigationItem, Story, SubNavigation, SubNavigationContent, SubNavigationFilter, SubNavigationGroup, SubNavigationHeader, SubNavigationItem, SubNavigationLink, SubNavigationList, SubNavigationTitle, Switch, Tab, TabContent, ReactTablePagination as TablePagination, Tabs, Tag, TextArea, TextInput, Toggle, Tooltip, Unit, User, Value, Wrapper, notificationStyle, pageWidths, tooltipStyle, tooltipStyleDark };
